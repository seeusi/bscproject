...
for num in range (500):
    parameter1 = round(random.uniform(10,200), 3)
    parameter2 = round(random.uniform(20,200), 3)
    parameter3 = round((parameter1 * parameter1) + (2 * parameter2), 1)
    parameter4 = round(random.uniform(0,500), 3)
    parameter5 = round(random.uniform(50, 500), 3)
    parameter6 = round(random.uniform(30, 500), 3)
    parameter7 = round((parameter5 - parameter4), 1)
    parameter8 = round(random.uniform(100,200), 3)
    parameter9 = round(random.uniform(2,200), 3)
